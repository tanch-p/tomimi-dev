<script lang="ts">
	...
	$effect(() => updateFloor(page.data?.mapConfig?.floors ?? stageFloors));
...
<div {@attach clickOutside(() => (optionsOpen = false))} class="self-center mx-auto select-none">
	<button
		id="floor-options"
