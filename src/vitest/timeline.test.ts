...
import ro3_b6 from '../lib/data/stages/ro_stage_data/ro3/level_rogue3_b-6.json' with { type: 'json' };
import ro5_b5b from '../lib/data/stages/ro_stage_data/ro5/level_rogue5_b-5-b.json' with { type: 'json' };
